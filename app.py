...
# --- ИНИЦИАЛИЗАЦИЯ ---
st.set_page_config(page_title="SPELLING CONTROL v8", layout="wide")

def get_db():
    conn = sqlite3.connect('team_v8_final.db', check_same_thread=False)
    return conn
...
<style>
    ...
    .stButton>button { border-radius: 5px; font-weight: bold; width: 100%; border: none; height: 45px; }
